CREATE TRIGGER SS_ACCESSUSER_AUDIT_AD FOR SS_ACCESSUSER >> trigger.sql
ACTIVE AFTER DELETE POSITION 0 >> trigger.sql
AS >> trigger.sql
...
BEGIN >> trigger.sql
  ...
  insert into auditlog (username, tablename, newrecordid, actiondate) values (coalesce(:username, :conn_id), 'ss_accessuser', null, CURRENT_TIMESTAMP); >> trigger.sql
END !! >> trigger.sql
